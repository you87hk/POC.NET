...
Friend Class nbMain
	...
	Private Const tcPrev As String = "Prev"
	Private Const tcNext As String = "Next"
	...
	Private Sub nbMain_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
	...
	Private Sub nbMain_Deactivate(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Deactivate
	...
	Private Sub nbMain_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
	...
	Private Sub nbMain_FormClosing(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
...
ErrHand: 
	...
	Private Sub nbMain_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
	...
	Private Sub lvwDB_ColumnClick(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.ColumnClickEventArgs) Handles lvwDB.ColumnClick
	...
	Private Sub lvwDB_DoubleClick(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles lvwDB.DoubleClick
	...
	Private Sub lvwDB_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles lvwDB.KeyPress
		Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
		If KeyAscii = System.Windows.Forms.Keys.Return Then
			KeyAscii = System.Windows.Forms.Cursors.Default
	...
	Private Sub lvwDB_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles lvwDB.Leave
		Dim i As Object
	...
	Public Sub mnuACCRPTSub_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles mnuACCRPTSub.Click
		Dim Index As Short = mnuACCRPTSub.GetIndex(eventSender)
		Call Call_Pgm(waAccRptSub, Index)
	End Sub
	
	Public Sub mnuListSub_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles mnuListSub.Click
		Dim Index As Short = mnuListSub.GetIndex(eventSender)
		Call Call_Pgm(waListSub, Index)
	End Sub
	
	Public Sub mnuFileSub_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles mnuFileSub.Click
		Dim Index As Short = mnuFileSub.GetIndex(eventSender)
		Call Call_Pgm(waFileSub, Index)
	End Sub
	
	Public Sub mnuMasterSub_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles mnuMasterSub.Click
		Dim Index As Short = mnuMasterSub.GetIndex(eventSender)
		Call Call_Pgm(waMasterSub, Index)
	End Sub
	
	Public Sub mnuOperationSub_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles mnuOperationSub.Click
		Dim Index As Short = mnuOperationSub.GetIndex(eventSender)
		Call Call_Pgm(waOperationSub, Index)
	End Sub
	
	Public Sub mnuInventorySub_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles mnuInventorySub.Click
	...
	Private Sub tbrMain_ButtonClick(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles _tbrMain_Button1.Click, _tbrMain_Button2.Click, _tbrMain_Button3.Click, _tbrMain_Button4.Click, _tbrMain_Button5.Click, _tbrMain_Button6.Click, _tbrMain_Button7.Click, _tbrMain_Button8.Click, _tbrMain_Button9.Click, _tbrMain_Button10.Click
