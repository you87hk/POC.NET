...
Change_SQLDate_Err: 
	...
	End Function
	Public Sub Get_Scr_Item(ByVal InPgmID As String, ByRef inArray As XArrayDBObject.XArrayDB)
	...
	End Sub
	Public Function Get_Caption(ByVal inArray As XArrayDBObject.XArrayDB, ByVal inCode As String) As String
